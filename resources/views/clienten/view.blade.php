...
<body>
    ...
    <div class="dashboard-container">
        ...
        <main class="dashboard-content-container">
            ...
            <div class="flex-row">
                <a href="/client/edit/{{ $clientInfo->clientId }}" class="btn1"><i class="fa-solid fa-pen"></i> Bewerk client</a>&nbsp&nbsp&nbsp
                    <a href="/client/archive/{{ $clientInfo->clientId }}" class="btn1"><i class="fa-solid fa-check"></i> Maak client afgehandeld</a>
            </div>
            @endif 
            <section class="flex-row gap-medium">
                <div class=s1>
